...
namespace Slate {
	...
	public:
		...
		uint32_t findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlagBits memPropertyBits) const;
	...
	public:
		...
		VmaAllocationInfo getImageAllocInfo(InternalTextureHandle handle);
	};
}